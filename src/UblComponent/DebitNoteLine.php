...
class DebitNoteLine extends BaseComponent
{

    const DECIMALS = 2;

    protected $ID;
    protected $DebitedQuantity;
    protected $unitCode;
    ...
    function xmlSerialize(Writer $writer): void
    {
        ...
        $writer->write([
            ...
            [
                'name' => SchemaNS::CBC . 'DebitedQuantity',
                'value' => $this->DebitedQuantity,
                'attributes' => [
    ...
    public function setDebitedQuantity($DebitedQuantity)
    {
